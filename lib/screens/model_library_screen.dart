            ...
            return ListView(
              ...
              children: [
                ...
                ...List.generate(filtered.length, (index) {
                  ...
                  // Hosted models (e.g. Piwi AI) never go through the
                  // download/RAM/load pipeline — skip those lookups entirely.
                  final isDl = !model.isHosted &&
                      downloaded.contains(model.filename);
                  final isActiveDownload = !model.isHosted &&
                      manager.isDownloading(model.filename);
                  final dlState =
                      model.isHosted ? null : manager.getDownloadState(model.filename);
                  ...
                  return Column(
                    children: [
                      ModelCard(
                        ...
                        onOpenHosted: model.isHosted && model.webviewUrl != null
                            ? () => Get.to(
                                  () => AppWebViewScreen(
