...
class ChatStorageService extends GetxService {
  ...
  /// Path to a custom AI avatar image on disk. Empty string means "use the
  /// default SylphTools avatar bundled with the app".
  String get aiAvatarPath =>
      _settingsBox.get('ai_avatar_path', defaultValue: '') as String;

  set aiAvatarPath(String value) => _settingsBox.put('ai_avatar_path', value);
}
