...
class ModelCard extends StatelessWidget {
  ...
  /// Called when the "Open" button is tapped on a hosted model
  /// (model.isHosted == true). Ignored for regular on-device models.
  final VoidCallback? onOpenHosted;
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                for (final tag in model.tags) _tagBadge(tag),
            ...
            // ── Hosted models skip size/RAM/download entirely ──────
            if (model.isHosted) ...[
              Row(
                children: [
                  Icon(Icons.cloud_outlined, size: 14, color: context.textD),
  ...
  Widget _tagBadge(String text) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.custom.withOpacity(0.12),
        borderRadius: BorderRadius.circular(4),
      ),
      child: Text(
        text,
